<?php
/*
Plugin Name: Ruven Themes: Portfolio
Description: Extends the functionality of Ruven Themes by adding a Portfolio post type
Version: 1.0
Author: Ruven
...
if(!class_exists('rt_portfolio')):
  ...
  class rt_portfolio {
    ...
    function __construct()
    {
      ...
      // Portfolio Taxonomy
      if(!get_option('rtp_disable_portfolio_tax_type')) {
    ...
    {
      $labels = apply_filters('rt_portfolio_labels', array(
      ...
      $args = apply_filters('rt_portfolio_args', array(
        'labels'              => $labels,
        'public'              => true,
    ...
    {
      $labels = apply_filters('rt_portfolio_tax_labels', array(
      ...
      $args = apply_filters('rt_portfolio_tax_args', array(
        'labels'            => $labels,
        'public'            => true,
        'query_var'         => true,
        'hierarchical'      => true,
